...
<div class="container" style="
    ...
    <div class="row">
      <div class="titreprod">
        <h2>Service/Produit de Robinetterie</h2>
      </div>
        <?php
        $servername = "localhost"; // Change if necessary
        $username = "root"; // Change if necessary
        ...
        $sql = "SELECT categorie_prod, NOM_PDT, DESCR_PDT, PRIX_PDT, image_pdt FROM produit WHERE categorie_prod = ?";
        ...
        if ($stmt) {
            ...
            while ($stmt->fetch()) {
                ...
                echo '<a href="details-pdt_robinet.php?product=' . urlencode($NOM_PDT) . '" class="Commander">Commander</a>';

                echo '        </div>';
                echo '        <div class="product-content">';
                echo '            <h3 class="title">' . $NOM_PDT . '</h3>';
