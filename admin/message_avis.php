               ...
               <li>
                ...
                <li id="lii">
                        ...
                        <form action="logout.php" method="post">
                            <div class="tit">
                                <ion-icon style="color:white; font-size: 31px;" name="log-out-outline"></ion-icon>
                                <input type="submit" value="Logout" id="subi">
...
function showMore() {
    ...
    xhr.open("GET", `loadMoreData.php?offset=${offset}`, true);
    xhr.onload = function () {
        if (xhr.status === 200) {
