...
<body>
    ...
    <script>
        ...
        function performSearch() {
            ...
            <script>
                $(document).ready(function() {
                    $('#button1').click(function() {
                        $('#section1').show();
                        $('#section2').hide();
                        document.getElementById('button1').style.backgroundColor='#ffeee9';
                        document.getElementById('button1').style.color= '#f35525' ;
                        document.getElementById('button1').style.border= '#ffeee9' ;
                        document.getElementById('button2').style.backgroundColor= '#f35525';
                        document.getElementById('button2').style.color= '#ffeee9' ;
                        document.getElementById('button2').style.border= '#f35525' ;
                    ...
                    $('#button2').click(function() {
                        $('#section1').hide();
                        $('#section2').show();
                        document.getElementById('button2').style.backgroundColor='#ffeee9';
                        document.getElementById('button2').style.color= '#f35525' ;
                        document.getElementById('button2').style.border= '#ffeee9' ;
                        document.getElementById('button1').style.backgroundColor= '#f35525';
                        document.getElementById('button1').style.color= '#ffeee9' ;
                        document.getElementById('button1').style.border= '#f35525' ;
            ...
            <div class="btnclass"> 
                <button id="button1" class="active">ajouter fournisseur</button>
                    <button id="button2">Suprimer un fournisseur</button>
                </div> 
            ...
            <section id="section3">
                ...
                <div class="card">
                    ...
                    <p>Entrez les information</p>
                    <form method="post" action="fourphp.php"class="form">
                        <div>
                            <input  class="passInput" type="text" id="email_oub" placeholder="nom fournisseur" name="nom"  required>
                       </div>
                        <div>
                         <input  class="passInput" type="text" id="email_oub" placeholder="prenom fournisseur" name="prenom"  required>
                    </div>
                    <div>
                    
                       <input class="passInput" type="text" id="tel_oub" placeholder="Email" name="email" required>
                    </div>
                    <div>
                    
                       <input class="passInput" type="number" id="tel_oub" placeholder="telephone" name="tele" required>
                    </div>
                    <div>
                    
                        <input class="passInput" type="text" id="tel_oub" placeholder="Adresse" name="adresse" required>
                     </div>
                   <div style="display:flex; justify-content:space-evenly; padding-top: 24px;">
                       <button id="butsub" type="submit" name="submit">enregistrer</button>
            ...
            <div id="section2" style="display: none;" class="section">
                <section id="section3">
                    <div class="card" style="    width: 57%;">
                        
                        <p class="lock-icon"><i id="icon" class="fas fa-user"></i></p>
                        <h2>suprimmer fourniseur</h2>
                        <p>Remplir les champs suivants</p>
                        <form id="newadmin" method="post" action="supfour.php"class="form">
                            <div>
                                <input  class="passInput" type="text" id="email_oub1" placeholder="EMAIL fournisseur" name="FOURSUP"  required>
                       ...
                       <div style="display:flex; justify-content:space-evenly; padding-top: 24px;">
                           <button id="butsub" class="ajouter_but" type="submit" name="submit" >suprimer</button>
