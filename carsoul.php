...
$dbname = "projet_finetude";
    ...
    if ($stmt) {
        ...
        echo '<div id="product-slidercarr" class="carousel slide" data-ride="carousel">';
        ...
        // Carousel controls
        echo '<a class="carousel-control-prev" href="#product-slidercarr" role="button" data-slide="prev">';
        echo '<span id="swiper" class="carousel-control-prev-icon" aria-hidden="true"></span>';
        echo '<span class="sr-only">Previous</span>';
        echo '</a>';
        echo '<a class="carousel-control-next" href="#product-slidercarr" role="button" data-slide="next">';
